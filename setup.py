...
setup(
    name='tendril-structures-psl',
    use_scm_version={"root": ".", "relative_to": __file__},
    author="Chintalagiri Shashank",
    author_email="shashank@chintal.in",
    description="Tendril Structure Support for PSLs",
    long_description='\n'.join([read('README.rst'), read('CHANGELOG.rst')]),
    long_description_content_type='text/x-rst',
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-structures-psl',
    project_urls={
        'Documentation': 'https://tendril-structures-psl.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-structures-psl/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-structures-psl',
    },
