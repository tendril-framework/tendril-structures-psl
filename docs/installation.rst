...
``tendril-structures-psl`` can be installed normally from the Python Package Index.
...
.. code-block:: console
    ...
    $ pip install tendril-structures-psl
...
`github releases <https://github.com/tendril-framework/tendril-structures-psl/releases>`_.
...
``tendril-structures-psl``. ``sudo`` may be necessary if you are not installing
into a virtual environment.

.. code-block:: console

    $ git clone https://github.com/tendril-framework/tendril-structures-psl.git
    $ cd tendril-structures-psl
    $ pip install -e .
